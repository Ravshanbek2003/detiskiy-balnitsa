...
export interface SalaryLogDocumentI {
   ...
   paid_patient_count: number //umumiy bemorlar soni ichida qancha to'lov qilingan
   amount: number
...
const documentSchema = new Schema<SalaryLogDocumentI>(
   {
      ...
      all_patient_count: { type: Number, required: true },
      paid_patient_count: { type: Number, required: true },
   },
   {
      versionKey: false,
